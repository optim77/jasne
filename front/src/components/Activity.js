...
function Activity() {
    ...
    const fetchNewsActivity = async (pageNewsCount) => {
        try {
            let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/profile/news/activity?page=` + pageNewsCount, {
                method: "POST",
                headers: {
    ...
    const fetchCommentsActivity = async (pageCommentsCount) => {
        try {
            let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/profile/comments/activity?page=` + pageCommentsCount, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Accept": "application/json",
    ...
    const handleDeleteNews = async (id) => {
        try {
            let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/profile/news/delete`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Accept": "application/json",
    ...
    const handleDeleteComments = async (id) => {
        try {
            let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/profile/comments/delete`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Accept": "application/json",
