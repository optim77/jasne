...
function AdminCategoryPanel() {
    ...
    const getCategories = async () => {
        let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/category/all`, {
            method: "GET",
            headers: {
    ...
    const handleUpdateCategory = async () => {
        if (selectedCategory) {
            let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/admin/category/update`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleCreateCategory = async () => {
        let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/admin/category/create`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const handleDelete = async(id) => {
        ...
        if(confirm("By deleting a category you delete all posts belonging to that category!")){
            let res = await fetch(`${process.env.REACT_APP_API_ADDRESS}/admin/category/delete`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                },
