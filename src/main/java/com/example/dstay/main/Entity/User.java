...
public class User implements UserDetails {
    ...
    @Column(name = "name", nullable = true, unique = false, length = 25)
    private String name;

    @Column(name = "surname", nullable = true, unique = false, length = 100)
    private String surname;

    @Column(name = "specialization", nullable = true, unique = false, length = 255)
