...
function UsersAdminPanel() {
    ...
    const getPanel = async (page) => {
        try {
            let res = await fetch("http://localhost:8080/admin/users?page=" + page, {
                method: "POST",
                headers: {
    ...
    const handleBlockUser = async (id) => {
        try {
            let res = await fetch("http://localhost:8080/admin/block", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                                            ...
                                            <div key={user.id} className="container mt-3">
                                                <div className="row">
                                                    ...
                                                    <button
                                                        ...
                                                        className={user.enabled ? 'btn btn-danger mb-2' : 'btn btn-primary mb-2'}
                                                    >
